 ...
 * @since             1.0.0
 *
 * Plugin Name:       CF7 to Webhook to readyMode
 * Plugin URI:        https://github.com/masterfermin02/cf7-for-readymode
 * Description:       Use Contact Form 7 as a trigger to any webhook!
 * Version:           1.0.0
 * Author:            Fermin Perdomo
 * Author URI:        https://fperdomo.dev
 * Text Domain:       cf7-to-webhook-to-readymode
...
if ( ! class_exists( 'Cf7_To_ReadyMode' ) ) {

    class Cf7_To_ReadyMode {
        ...
        private function add_modules() {
            ...
            require_once plugin_dir_path(__FILE__) . 'modules/readymode/class-module-ready-mode.php';

            // Instantiate the Module's classes:
            $this->modules['cf7'] = new CFTZ_Module_CF7( $this );
            $this->modules['zapier'] = new CFTZ_Module_Ready_Mode( $this );
        }
